 ...
 */
class MockUpdatePaymentDetailsProxy implements PaymentsProxy
{
    /**
    ...
    {
        return new StartTransactionResult(ResultCode::error());
    }

    public function setMockResult(UpdatePaymentDetailsResult $result): void
    {
        $this->result = $result;
    }
