...
class ProxyTest extends BaseTestCase
{
    ...
    {
        return "{\"notification\":{\"paymentMethod\":\"visa\",\"merchantReference\":\"testWebhook\",\"eventCode\":\"AUTHORISATION\",\"amount\":{\"currency\":\"EUR\",\"value\":1000},\"reason\":\"Authorize visa payment\",\"success\":true},\"types\":[\"CUSTOM\"]}";
    }
}
