...
use Adyen\Core\Tests\Infrastructure\Common\TestComponents\TaskExecution\AbortTask;
use Adyen\Core\Tests\Infrastructure\Common\TestComponents\TaskExecution\BarTask;
...
class QueueTest extends TestCase
{
    ...
    /**
     * @throws \Adyen\Core\Infrastructure\TaskExecution\Exceptions\QueueItemDeserializationException
     * @throws \Adyen\Core\Infrastructure\TaskExecution\Exceptions\QueueStorageUnavailableException
     * @throws \Adyen\Core\Infrastructure\TaskExecution\Exceptions\AbortTaskExecutionException
     */
    ...
    /**
     * @param \Adyen\Core\Infrastructure\TaskExecution\QueueItem $queueItem
     *
     * @throws \Adyen\Core\Infrastructure\ORM\Exceptions\EntityClassException
     * @throws \Adyen\Core\Infrastructure\ORM\Exceptions\QueryFilterInvalidParamException
     * @throws \Adyen\Core\Infrastructure\TaskExecution\Exceptions\QueueItemDeserializationException
     ...
     * @param \Adyen\Core\Infrastructure\TaskExecution\Task $task
     *
     * @return \Adyen\Core\Infrastructure\TaskExecution\QueueItem
     *
     * @throws \Adyen\Core\Infrastructure\TaskExecution\Exceptions\QueueItemDeserializationException
     * @throws \Adyen\Core\Infrastructure\TaskExecution\Exceptions\QueueStorageUnavailableException
     * @throws \Adyen\Core\Infrastructure\TaskExecution\Exceptions\AbortTaskExecutionException
