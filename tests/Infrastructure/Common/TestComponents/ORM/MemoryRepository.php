...
use Adyen\Core\Infrastructure\ORM\Interfaces\MassInsert;
 ...
 *
 * @package Adyen\Core\Tests\Infrastructure\Common\TestComponents\ORM
 */
class MemoryRepository implements RepositoryInterface, MassInsert
{
     ...
     *
     * @param \Adyen\Core\Infrastructure\ORM\Entity $entity Entity to be saved
     */
     ...
     * @param array $result
     *
     * @return \Adyen\Core\Infrastructure\ORM\Entity[]
     * @throws \Adyen\Core\Infrastructure\ORM\Exceptions\EntityClassException
     */
